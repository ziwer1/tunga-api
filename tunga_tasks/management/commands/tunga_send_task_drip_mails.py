...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        past_by_48_hrs = utc_now - relativedelta(hours=48)  # 24 hour window to complete task
        past_by_15_mins = utc_now - relativedelta(minutes=15)  # 24 hour window to complete task
